...
class ReferenceFileFrontendContractTests(unittest.TestCase):
    ...
    def test_cache_versions_are_bumped_once(self) -> None:
        ...
        self.assertIn("runtime-658", index)
        self.assertIn("runtime-658", history)
        self.assertIn("history-79", history)
        self.assertIn('ilab-conjure-shell-v128', worker)
        self.assertIn('/static/app.js?v=runtime-658', worker)
        self.assertIn('/static/styles.css?v=runtime-658', worker)
