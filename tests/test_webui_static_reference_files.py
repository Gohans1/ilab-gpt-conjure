...
class ReferenceFileFrontendContractTests(unittest.TestCase):
    ...
    def test_cache_versions_are_bumped_once(self) -> None:
        ...
        self.assertIn("runtime-782", index)
        self.assertIn("runtime-782", history)
        self.assertIn("history-112", history)
        self.assertIn('ilab-conjure-shell-v259', worker)
        self.assertIn('/static/app.js?v=runtime-782', worker)
        self.assertIn('/static/styles.css?v=runtime-782', worker)
