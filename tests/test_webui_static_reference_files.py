...
class ReferenceFileFrontendContractTests(unittest.TestCase):
    ...
    def test_cache_versions_are_bumped_once(self) -> None:
        ...
        self.assertIn("runtime-783", index)
        self.assertIn("runtime-783", history)
        self.assertIn("history-112", history)
        self.assertIn('ilab-conjure-shell-v260', worker)
        self.assertIn('/static/app.js?v=runtime-783', worker)
        self.assertIn('/static/styles.css?v=runtime-783', worker)
