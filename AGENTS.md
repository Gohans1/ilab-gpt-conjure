...
- CẤM động vào phần oauth token session cookie khi chưa thực sự có best-practice, đây là phần cực kì nhạy cảm, nếu không có best-practice hay code mẫu chuẩn chỉ thì CỰC KÌ dễ làm sai, WARNING user nếu chưa có đủ. Toàn bộ phần oauth login session cookie token của chatgpt web phần lớn được tham khảo từ: https://github.com/miuuyy/codex-chatgpt-web . Khi thực sự cần thay đổi hay có lỗi gì liên quan đến khu vực này thì hãy clone về mà dùng codegraph tham khảo, và dùng websearch nếu cần
- 
...
- Sau khi đăng nhập bằng google lần đầu tiên thì nó popup ra accounts.google.com.vn/accounts/SetSID rồi mới chuyển sang chatgpt.com
- User dùng gói Plus nên được tạo ảnh thoải mái
