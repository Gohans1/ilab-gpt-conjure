...
export function createWebUIElements(): WebUIElements {
  ...
  chatgptBrowserField: document.querySelector<HTMLElement>("#chatgptBrowserField"),
  chatgptBrowserGroup: document.querySelector<HTMLElement>("#chatgptBrowserGroup"),
  chatgptBrowser: document.querySelector<HTMLInputElement>("#chatgptBrowser"),
